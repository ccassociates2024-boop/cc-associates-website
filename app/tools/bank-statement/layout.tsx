...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://cc-associates-website.vercel.app/tools/bank-statement" },
  openGraph: {
    title: "Free Bank Statement Analyser | CC Associates",
    description: "Upload bank statement CSV and get instant expense summary & insights. 100% private.",
    url: "https://cc-associates-website.vercel.app/tools/bank-statement",
